...
var _ asset.Asset = (*OpenshiftServiceCertSignerNamespace)(nil)
...
func (t *OpenshiftServiceCertSignerNamespace) Generate(parents asset.Parents) error {
	data, err := common.GetBootkubeTemplate(openshiftServiceCertSignerNamespaceFileName)
	if err != nil {
		return err
	}
	t.file = &asset.File{
		Filename: filepath.Join(common.TemplateDir, openshiftServiceCertSignerNamespaceFileName),
		Data:     []byte(data),
	}
	return nil
}
...
func (t *OpenshiftServiceCertSignerNamespace) Load(f asset.FileFetcher) (bool, error) {
	file, err := f.FetchByName(filepath.Join(common.TemplateDir, openshiftServiceCertSignerNamespaceFileName))
	if err != nil {
